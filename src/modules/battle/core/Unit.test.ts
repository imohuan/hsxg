    ...
    fc.assert(
      fc.property(
        ...
        (stats, damage) => {
          ...
          const { newHp, newState } = computeStateAfterHpChange(stats.hp, stats.maxHp, lethalDamage, initialState);
    ...
    fc.assert(
      fc.property(
        ...
        (stats, hpChange) => {
          ...
          const { newHp, newState } = computeStateAfterHpChange(stats.hp, stats.maxHp, hpChange, initialState);
